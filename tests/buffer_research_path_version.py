...
import unittest
import pandas as pd
from src.buffer_research_path_version import apply_batch_trades_on_buffer_and_account_trade_statistic, count_number_of_amm_interactions_due_to_opp_cow_or_unidirectional_cows

test_trades = [{'block_number': 14123254, 'project': 'Uniswap', 'version': 1,
                'token_a_address': '\\xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 'token_a_amount_raw': 1268800000000000000, 'token_a_symbol': 'ETH', 'token_b_address': '\\x2b591e99afe9f32eaa6214f7b7629768c40eeb39', 'token_b_amount_raw': 1878565823884, 'token_b_symbol': 'HEX', 'usd_amount': 3395.78951154391}, {'block_number': 14123256, 'project': 'Uniswap', 'version': 1, 'token_a_address': '\\xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 'token_a_amount_raw': 113993750000000000, 'token_a_symbol': 'ETH', 'token_b_address': '\\x9e32b13ce7f2e80a01932b42553652e053d6ed8e', 'token_b_amount_raw': 2564494508536733779, 'token_b_symbol': 'Metis', 'usd_amount': 319.291934}]

test_trades_opposite_direction = [{'block_number': 14123254, 'project': 'Uniswap', 'version': 1,
                                   'token_a_address': '\\xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 'token_a_amount_raw': 1268800000000000000, 'token_a_symbol': 'ETH', 'token_b_address': '\\x2b591e99afe9f32eaa6214f7b7629768c40eeb39', 'token_b_amount_raw': 1878565823884, 'token_b_symbol': 'HEX', 'usd_amount': 3395.78951154391}, {'block_number': 14123256, 'project': 'Uniswap', 'version': 1, 'token_a_address': '\\x2b591e99afe9f32eaa6214f7b7629768c40eeb39', 'token_a_amount_raw': 113993750000000000, 'token_a_symbol': 'Hex', 'token_b_address': '\\xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 'token_b_amount_raw': 2564494508536733779, 'token_b_symbol': 'ETH', 'usd_amount': 2919.291934}]

test_trades_same_direction = [{'block_number': 14123254, 'project': 'Uniswap', 'version': 1,
...
class TestApplyTradesOnBufferTest(unittest.TestCase):
    ...
    def test_count_number_of_saved_trades_uni_directional_cow(self):
        df = pd.DataFrame.from_records(test_trades_same_direction)
        saved_interactions = count_number_of_amm_interactions_due_to_opp_cow_or_unidirectional_cows(
            df)

        self.assertEqual(saved_interactions, 1)
    ...
    def test_count_number_of_saved_trades_from_2_and_1_trade_on_same_pair(self):
        ...
        self.assertEqual(saved_interactions, 2)

    def test_count_number_of_saved_trades_from_2_and_1_trade_on_same_pair(self):
        # two trades in one direction, one trade in opposite, but with different pool version
        new_trade_on_different_version = test_trades_opposite_direction[1]
        new_trade_on_different_version['version'] = 2
        test_trades_opposite_direction.append(new_trade_on_different_version
                                              )
        df = pd.DataFrame.from_records(test_trades_opposite_direction)
        saved_interactions = count_number_of_amm_interactions_due_to_opp_cow_or_unidirectional_cows(
            df)

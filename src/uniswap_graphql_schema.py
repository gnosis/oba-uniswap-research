...
class Burn_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'transaction', 'timestamp', 'pair', 'liquidity', 'sender', 'amount0', 'amount1', 'to', 'logIndex', 'amountUSD', 'needsComplete', 'feeTo', 'feeLiquidity')
...
class LiquidityPositionSnapshot_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'liquidityPosition', 'timestamp', 'block', 'user', 'pair', 'token0PriceUSD', 'token1PriceUSD', 'reserve0', 'reserve1', 'reserveUSD', 'liquidityTokenTotalSupply', 'liquidityTokenBalance')
...
class Mint_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'transaction', 'timestamp', 'pair', 'to', 'liquidity', 'sender', 'amount0', 'amount1', 'logIndex', 'amountUSD', 'feeTo', 'feeLiquidity')
...
class PairDayData_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'date', 'pairAddress', 'token0', 'token1', 'reserve0', 'reserve1', 'totalSupply', 'reserveUSD', 'dailyVolumeToken0', 'dailyVolumeToken1', 'dailyVolumeUSD', 'dailyTxns')


class PairHourData_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'hourStartUnix', 'pair', 'reserve0', 'reserve1', 'reserveUSD', 'hourlyVolumeToken0', 'hourlyVolumeToken1', 'hourlyVolumeUSD', 'hourlyTxns')


class Pair_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'token0', 'token1', 'reserve0', 'reserve1', 'totalSupply', 'reserveETH', 'reserveUSD', 'trackedReserveETH', 'token0Price', 'token1Price', 'volumeToken0', 'volumeToken1', 'volumeUSD', 'untrackedVolumeUSD', 'txCount', 'createdAtTimestamp', 'createdAtBlockNumber', 'liquidityProviderCount')
...
class Swap_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'transaction', 'timestamp', 'pair', 'sender', 'amount0In', 'amount1In', 'amount0Out', 'amount1Out', 'to', 'logIndex', 'amountUSD')


class TokenDayData_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'date', 'token', 'dailyVolumeToken', 'dailyVolumeETH', 'dailyVolumeUSD', 'dailyTxns', 'totalLiquidityToken', 'totalLiquidityETH', 'totalLiquidityUSD', 'priceUSD', 'maxStored', 'mostLiquidPairs')


class Token_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'symbol', 'name', 'decimals', 'totalSupply', 'tradeVolume', 'tradeVolumeUSD', 'untrackedVolumeUSD', 'txCount', 'totalLiquidity', 'derivedETH', 'mostLiquidPairs')
...
class UniswapDayData_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'date', 'dailyVolumeETH', 'dailyVolumeUSD', 'dailyVolumeUntracked', 'totalVolumeETH', 'totalLiquidityETH', 'totalVolumeUSD', 'totalLiquidityUSD', 'maxStored', 'mostLiquidTokens', 'txCount')


class UniswapFactory_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_graphql_schema
    __choices__ = ('id', 'pairCount', 'totalVolumeUSD', 'totalVolumeETH', 'untrackedVolumeUSD', 'totalLiquidityUSD', 'totalLiquidityETH', 'txCount', 'mostLiquidTokens')
...
class Bundle_filter(sgqlc.types.Input):
    __schema__ = uniswap_graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'eth_price', 'eth_price_not', 'eth_price_gt', 'eth_price_lt', 'eth_price_gte', 'eth_price_lte', 'eth_price_in', 'eth_price_not_in')
...
class User_filter(sgqlc.types.Input):
    __schema__ = uniswap_graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'usd_swapped', 'usd_swapped_not', 'usd_swapped_gt', 'usd_swapped_lt', 'usd_swapped_gte', 'usd_swapped_lte', 'usd_swapped_in', 'usd_swapped_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
